	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="" src="images/doctor2.jpg">
			</div>
					...
					<div class="card-body">
						...
						<form class="row g-3" action="appAppointment" method="post">
							...
							<div class="col-md-6">
								...
								type="email" size="30" placeholder="enter your email" required type="email" class="form-control" name="email"/>
							</div>

							<div class="col-md-6">
								<label for="inputEmail4"class="form-label">Phone No</label> <input type="tel"
									maxlength="10"  size="10" required type="number" class="form-control"
									name="phno">
							</div>
